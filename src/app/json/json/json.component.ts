...
export class JsonComponent implements OnInit {
  ...
  editorTextOptions: JsonEditorOptions = {
    escapeUnicode: false,
  ...
  editorTreeOptions: JsonEditorOptions = {
    escapeUnicode: false,
    sortObjectKeys: false,
    history: true,
    mode: 'tree',
  ...
  constructor() {
    this.editorTextOptions.onChange = () => {
      try {
        this.data = this.editorText.get();
        if (this.data) {
  ...
  ngOnInit() {
    this.editorText = new JSONEditor(this.textElem.nativeElement, this.editorTextOptions, this.data);
    this.editorTree = new JSONEditor(this.treeElem.nativeElement, this.editorTreeOptions, this.data);
  }
}
