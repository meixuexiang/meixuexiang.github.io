...
export const routes: Routes = [
  {
    path: 'regexp',
    loadChildren: '@ngx-nrwl-workspace/regexp#RegexpModule',
    data: {
      name: '正则编辑器',
      version: '2.0',
      email: 'wy_hd@163.com',
  ...
  {
    path: 'hostseditor',
    loadChildren: '@ngx-nrwl-workspace/hostseditor#HostseditorModule',
    data: {
      name: 'Hosts编辑器',
      version: '4.0',
      email: 'wy_hd@163.com',
  ...
  {
    path: 'json',
    loadChildren: '@ngx-nrwl-workspace/json#JsonModule',
    data: {
      name: 'JSON',
      version: '1.0',
      email: 'wy_hd@163.com',
  ...
  {
    path: 'payslip',
    loadChildren: '@ngx-nrwl-workspace/payslip#PayslipModule',
    data: {
      name: '群发工资条',
      version: '1.0',
      email: 'wy_hd@163.com',
  ...
  {
    path: 'sxwnl',
    loadChildren: '@ngx-nrwl-workspace/sxwnl#SxwnlModule',
    data: {
      name: '寿星万年历',
      version: '1.0',
      email: 'wy_hd@163.com',
  ...
  {
    path: 'uglify',
    loadChildren: '@ngx-nrwl-workspace/uglify#UglifyModule',
    data: {
      name: 'UglifyJs',
      version: '1.0',
      email: 'wy_hd@163.com',
  ...
  {
    path: 'timestamp',
    loadChildren: '@ngx-nrwl-workspace/timestamp#TimestampModule',
    data: {
      name: '时间戳',
      version: '1.0',
      email: 'wy_hd@163.com',
...
export class LaunchpadComponent implements OnInit {
  ...
  openURL(event: any, url: string, width: number = 800, height: number = 600) {
    ...
    win.loadURL(`${location.origin}/app-router/${url}`);
    console.log(`Opening: `, `${location.origin}/app-router/${url}`);
    win.show();
  }
