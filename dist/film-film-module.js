...
MatDividerModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function MatDividerModule_Factory(t) { return new (t || MatDividerModule)(); }, imports: [[_angular_material_core__WEBPACK_IMPORTED_MODULE_3__["MatCommonModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"]],
        _angular_material_core__WEBPACK_IMPORTED_MODULE_3__["MatCommonModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](MatDividerModule, { declarations: function () { return [MatDivider]; }, imports: function () { return [_angular_material_core__WEBPACK_IMPORTED_MODULE_3__["MatCommonModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"]]; }, exports: function () { return [MatDivider,
        _angular_material_core__WEBPACK_IMPORTED_MODULE_3__["MatCommonModule"]]; } }); })();
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/film/index/index.component.html":
/*!***************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/film/index/index.component.html ***!
  \***************************************************************************************/
...
function toByteArray(t) {
  var e,
    ...
    s,
    u = t.length;
  (a = NYY(t)), (s = new Uint8Array((3 * u) / 4 - a)), (o = a > 0 ? u - 4 : u);
  var c = 0;
...
function write(that, t, e, r, n) {
  if (void 0 === e) (n = "utf8"), (r = that.length), (e = 0);
  else if (void 0 === r && "string" == typeof e)
    (n = e), (r = that.length), (e = 0);
  else {
    if (!isFinite(e))
      throw new Error(
  ...
  if (
    ((void 0 === r || r > o) && (r = o),
    (t.length > 0 && (r < 0 || e < 0)) || e > that.length)
  )
...
function copy(that, t, e, r, n) {
  if (
    ...
    return 0;
  if (0 === t.length || 0 === that.length) return 0;
  if (e < 0) throw new RangeError("targetStart out of bounds");
  if (r < 0 || r >= that.length)
    throw new RangeError("sourceStart out of bounds");
  if (n < 0) throw new RangeError("sourceEnd out of bounds");
  n > that.length && (n = that.length),
    t.length - e < n - r && (n = t.length - e + r);
  var o,
    a = n - r;
  if (that === t && r < e && e < n)
    for (o = a - 1; o >= 0; --o) t[o + e] = that[o + r];
  else if (a < 1e3 || !!0) for (o = 0; o < a; ++o) t[o + e] = that[o + r];
  else Uint8Array.prototype.set.call(t, that.subarray(r, r + a), e);
  return a;
}
function I(t, e, r) {
...
function P(t) {
  ...
  for (var r = "", n = 0; n < e; )
    r += String.fromCharCode.apply(String, slice(t, n, (n += Q)));
  return r;
}
function k(t, e, r) {
  var n = "";
...
function toString(that, ...args) {
  var t = 0 | that.length;
  return 0 === t ? "" : 0 === args.length ? T(that, 0, t) : v.apply(that, args);
}
function readFloatBE(that, t, e) {
  return e || I(t, 4, that.length), J.read(that, t, !1, 23, 4);
}
function readDoubleBE(that, t, e) {
  return e || I(t, 8, that.length), J.read(that, t, !1, 52, 8);
}
function readUInt8(that, t, e) {
  return e || I(t, 1, that.length), that[t];
}
function readIntBE(that, t, e, r) {
  (t |= 0), (e |= 0), r || I(t, e, that.length);
  for (var n = e, o = 1, i = that[t + --n]; n > 0 && (o *= 256); )
    i += that[t + --n] * o;
  return (o *= 128), i >= o && (i -= Math.pow(2, 8 * e)), i;
}
function readUInt32BE(that, t, e) {
  return (
    e || I(t, 4, that.length),
    16777216 * that[t] +
      ((that[t + 1] << 16) | (that[t + 2] << 8) | that[t + 3])
  );
}
function concat(t, e) {
  if (!Array.isArray(t))
  ...
  for (r = 0; r < t.length; ++r) {
    ...
    if (!isBuffer(a))
      throw new TypeError('"list" argument must be an Array of Buffers');
    copy(a, n, o), (o += a.length);
  }
  return n;
}
function ff(t, e, r) {
  if ((("string" == typeof r && "" !== r) || (r = "utf8"), !isEncoding(r)))
    throw new TypeError('"encoding" must be a valid string encoding');
  var n = 0 | y(e, r);
  t = o(t, n);
  var a = write(t, e, r);
  return a !== n && (t = slice(t, 0, a)), t;
}
function d(t) {
  if (t >= n())
...
function p(t, e) {
  if (isBuffer(e)) {
    var r = 0 | d(e.length);
    return (t = o(t, r)), 0 === t.length ? t : (copy(e, t, 0, 0, r), t);
  }
  if (e) {
    if (
...
const UINT64 = (function(r) {
  ...
  function u(t, e) {
    (e = e || 10),
      ...
      (this._a48 = 0);
    for (
      var r = c[e] || new i(Math.pow(e, 5)), n = 0, o = t.length;
      n < o;
      n += 5
    ) {
  ...
  (i.prototype.fromBits = a),
    ...
    (i.prototype.toString = function(t) {
      ...
      for (
        var r = this.clone(), n = new Array(64), o = 63;
        o >= 0 &&
        (r.div(e), (n[o] = r.remainder.toNumber().toString(t)), r.gt(e));
        o--
      );
      return (n[o - 1] = r.toNumber().toString(t)), n.join("");
    }),
    ...
    (i.prototype.div = function(t) {
      if (0 == t._a16 && 0 == t._a32 && 0 == t._a48) {
        ...
        if (1 == t._a00) return (this.remainder = new i(0)), this;
      }
      if (t.gt(this))
        return (
  ...
  (o.prototype.init = i),
    (o.prototype.update = function(t) {
      ...
      if (
        ((this.total_len += c),
        0 == this.memsize &&
          (this.memory = o ? "" : r ? new Uint8Array(32) : new e(32)),
        this.memsize + c < 32)
      )
        return (
          o
            ...
            : copy(t, this.memory, this.memsize, 0, c),
          (this.memsize += c),
          this
        );
      if (this.memsize > 0) {
        o
          ? (this.memory += slice(t, 0, 32 - this.memsize))
          : r
          ? this.memory.set(t.subarray(0, 32 - this.memsize), this.memsize)
          : copy(t, this.memory, this.memsize, 0, 32 - this.memsize);
        var l = 0;
        if (o) {
          var h;
          (h = a(
        ...
        (i += 32 - this.memsize), (this.memsize = 0), o && (this.memory = "");
      }
      if (i <= f - 32) {
        var p = f - 32;
        do {
      ...
      return (
        i < f &&
          (o
            ? (this.memory += slice(t, i))
            : r
            ? this.memory.set(t.subarray(i, f), this.memsize)
            : copy(t, this.memory, this.memsize, i, f),
          (this.memsize = f - i)),
        this
      );
    }),
...
function RR(e) {
  ...
  for (var n, o = [], i = 0, a = new III(e.length), s = 0; s < 256; s++)
    o[s] = s;
  for (s = 0; s < 256; s++)
...
const EE = { maxObjectSize: 100000000, maxObjectCount: 32768 };
...
function ZZ(t) {
  ...
  function a(t, e, r) {
    return (e = e || 0), (r = r || t.length - e), readIntBE(t, e, r);
  }
  function p(r) {
    var n = r.offset,
      o = r.objInfo,
      i = Math.pow(2, o);
    if (i > 4) return u(slice(t, n + 1, n + 1 + i));
    if (i < EE.maxObjectSize) return a(slice(t, n + 1, n + 1 + i));
    throw new Error("4 " + i + " " + EE.maxObjectSize);
  }
  function d(r) {
    var n = r.offset,
      a = r.objInfo,
      s = a;
    if (s < EE.maxObjectSize) return o({}, h, i(slice(t, n + 1, n + 1 + s)));
    throw new Error("4 " + s + " " + EE.maxObjectSize);
  }
  function m(r) {
    var n = r.offset,
      o = r.objInfo,
      i = Math.pow(2, o);
    if (!(i < EE.maxObjectSize))
      throw new Error("4 " + i + " " + EE.maxObjectSize);
    var a = slice(t, n + 1, n + 1 + i);
    return 4 === i ? readFloatBE(a, 0) : 8 === i ? readDoubleBE(a, 0) : void 0;
  }
  function y(e) {
    var r = e.offset,
      n = e.objInfo;
    3 != n && console.error(5, n);
    var o = slice(t, r + 1, r + 9);
  ...
  function v(r) {
    ...
    if (15 == o) {
      ...
      var f = 15 & u,
        l = Math.pow(2, f);
      (a = 2 + l), (s = i(slice(t, n + 2, n + 2 + l)));
    }
    if (s < EE.maxObjectSize) return slice(t, n + a, n + a + s);
    throw new Error("4 " + s + " " + EE.maxObjectSize);
  }
  function g(r, o) {
    var a = r.offset,
    ...
    if (15 == s) {
      ...
      var d = 15 & h,
        m = Math.pow(2, d);
      (l = 2 + m), (f = i(slice(t, a + 2, a + 2 + m)));
    }
    if ((f *= o + 1) < EE.maxObjectSize) {
      var y = new III(slice(t, a + l, a + l + f));
      return o && ((y = c(y)), (u = "ucs2")), toString(y, u);
    }
    throw new Error("4 " + f + " " + EE.maxObjectSize);
  }
  function c(t) {
  ...
  function b(n) {
    ...
    if (15 == a) {
      ...
      var l = 15 & c,
        h = Math.pow(2, l);
      (u = 2 + h), (s = i(slice(t, o + 2, o + 2 + h)));
    }
    if (s * A > EE.maxObjectSize) throw new Error(4);
    for (var p = [], d = 0; d < s; d++) {
      var m = i(slice(t, o + u + d * A, o + u + (d + 1) * A));
      p[d] = r(m);
    }
    return p;
  }
  function w(n) {
    ...
    if (15 == a) {
      ...
      var p = 15 & l,
        d = Math.pow(2, p);
      (c = 2 + d), (u = i(slice(t, o + 2, o + 2 + d)));
    }
    if (2 * u * A > EE.maxObjectSize) throw new Error(4);
    // (0, f.debug)("Parsing dictionary #" + s);
    for (var m = {}, y = 0; y < u; y++) {
      var v = i(slice(t, o + c + y * A, o + c + (y + 1) * A)),
        g = i(slice(t, o + c + u * A + y * A, o + c + u * A + (y + 1) * A)),
        b = r(v),
        w = r(g);
      //   (0, f.debug)("  DICT #" + s + ": Mapped " + b + " to " + w);
      m[b] = w;
    }
    return m;
  }
  ...
  function s(t, e) {
    return readUInt32BE(slice(t, e, e + 8), 4, 8);
  }
  ...
  var _ = slice(t, t.length - 32, t.length),
    E = readUInt8(_, 6);
  //   (0, f.debug)("offsetSize: " + E);
  var A = readUInt8(_, 7);
  //   (0, f.debug)("objectRefSize: " + A);
  var C = s(_, 8);
  //   (0, f.debug)("numObjects: " + C);
  var x = s(_, 16);
  //   (0, f.debug)("topObject: " + x);
  var S = s(_, 24);
  //   (0, f.debug)("offsetTableOffset: " + S);
  if (C > EE.maxObjectCount) throw new Error(1);
  for (var O = [], T = 0; T < C; T++) {
    var P = slice(t, S + T * E, S + (T + 1) * E);
    O[T] = i(P, 0);
    // (0, f.debug)("Offset for Object #" +T +" is " +O[T] +" [" +O[T].toString(16) +"]");
  }
  return r(x);
}
...
//     l = r(80),
//     h = n(l),
//     p = ((e.debug = (0, u.default)("json-enctryptor")), { start: 2, end: 7 });
//   (e.$keys = "z"),
//     (e.$vals = "k"),
//     (e.$UID = "j"),
//     (e.$defaultRootUID = 4),
...
function decrypt(r) {
  var a = e.from(r, "base64"),
    ...
    u = slice(a, s, s + 16);
  a = concat([slice(a, 0, s), slice(a, s + 16)]);
  var c = hash(concat([u, e.from("")]));
  var l = {};
  l[c] = a;
  const x = RR(a, c);
  const y = ZZ(x);
...
/* harmony import */ var _index_index_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index/index.component */ "./src/app/film/index/index.component.ts");
    ...
    FilmModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild([{ path: '', pathMatch: 'full', component: _index_index_component__WEBPACK_IMPORTED_MODULE_2__["IndexComponent"] }]),
...
/***/ "./src/app/film/index/index.component.scss":
/*!*************************************************!*\
  !*** ./src/app/film/index/index.component.scss ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (":host {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n          flex-direction: row;\n  height: 100%;\n  font-size: 12px;\n  padding: 5px;\n  background: rgba(255, 255, 255, 0.9);\n}\n\nbutton {\n  padding: 0 20px;\n}\n\ninput[type=text] {\n  margin: 0 4px;\n}\n\n.left-part {\n  width: 50%;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  margin-right: 4px;\n}\n\n.left-part-head {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n          flex-direction: row;\n  height: 40px;\n  line-height: 40px;\n  padding: 4px 0;\n}\n\n.left-part-head .text-field {\n  -webkit-box-flex: 1;\n          flex: 1;\n  margin: 0 4px;\n}\n\n.left-part mat-tree {\n  -webkit-box-flex: 1;\n          flex: 1;\n  overflow: auto;\n}\n\n.right-part {\n  width: 50%;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n}\n\n.right-part-head {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n          flex-direction: row;\n  height: 40px;\n  line-height: 40px;\n  padding: 4px 0;\n}\n\n.right-part-head button {\n  margin-right: 8px;\n}\n\n.right-part-body {\n  -webkit-box-flex: 1;\n          flex: 1;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  overflow: hidden;\n}\n\n.right-part-body .right-part-space {\n  -webkit-box-flex: 1;\n          flex: 1;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  overflow: hidden;\n}\n\n.right-part-body .right-part-space .douban-search {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n          flex-direction: row;\n  height: 40px;\n  line-height: 40px;\n  padding: 4px 0;\n}\n\n.right-part-body .right-part-space .douban-search .keyword {\n  -webkit-box-flex: 1;\n          flex: 1;\n  margin-right: 4px;\n  padding: 0 4px;\n}\n\n.right-part-body .right-part-space .douban-result {\n  -webkit-box-flex: 1;\n          flex: 1;\n  overflow: auto;\n}\n\n.right-part-body .right-part-space .douban-result .douban-item {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n          flex-direction: row;\n  margin: 0 0 20px 0;\n}\n\n.right-part-body .right-part-space .douban-result .douban-item img {\n  width: 50px;\n}\n\n.right-part-body .right-part-space .douban-result .douban-item ul {\n  margin-left: 10px;\n}\n\n.right-part-body .right-part-space .douban-result .folder-item {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n          flex-direction: row;\n  -webkit-box-pack: justify;\n          justify-content: space-between;\n  margin: 6px 0;\n  background: #cccccc;\n}\n\n.right-part-body .right-part-space .douban-result .folder-item span {\n  margin-left: 6px;\n  line-height: 30px;\n  -webkit-box-flex: 1;\n          flex: 1;\n}\n\n.right-part-body .right-part-space .douban-result .folder-item button {\n  height: 30px;\n  line-height: 30px;\n  margin-left: 10px;\n  padding: 0 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ "./src/app/film/index/index.component.ts":
/*!***********************************************!*\
  !*** ./src/app/film/index/index.component.ts ***!
  \***********************************************/
...
/* harmony import */ var _core_explorer_explorer_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../core/explorer/explorer.component */ "./src/app/core/explorer/explorer.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var decrypt = __webpack_require__(/*! ../douban-decode */ "./src/app/film/douban-decode.js");
var superagent = __webpack_require__(/*! superagent */ "./node_modules/superagent/lib/client.js");
var IndexComponent = /** @class */ (function () {
    function IndexComponent(electron, _ngZone) {
        var _this = this;
        this.electron = electron;
        this._ngZone = _ngZone;
        this.folder = '/Volumes/青龙/电影';
        this.operator = '';
        this.doubanSearchName = '';
        this.doubanSearchResult = null;
        this.folderSearchName = '';
        this.folderSearchResult = null;
        this.electron.ipcRenderer.on('select-dir', function (event, _a) {
            var canceled = _a.canceled, _b = _a.filePaths, filePath = _b[0], others = _b.slice(1);
            console.log(canceled, filePath);
            _this._ngZone.run(function () { return _this.folder = filePath; });
        });
    }
    ...
    IndexComponent.prototype.selectDir = function () {
        this.electron.ipcRenderer.send('select-dir');
    };
    IndexComponent.prototype.setDir = function (folder) {
    ...
    IndexComponent.prototype.explorerErrorHandler = function (err) {
        console.log('explorerErrorHandler', err);
    };
    IndexComponent.prototype.doubanOperate = function () {
        this.operator = 'douban';
        var _a = this.explorer.getSelected(), name = _a.name, fullpath = _a.fullpath, expandable = _a.expandable;
        this.doubanSearchName = (expandable ? name : name.replace(/\.\w+$/, '')).replace(/[\`\~\!\@\#\$\%\^\&\*\(\)\_\+\-\=\{\}\|\[\]\\\:\"\;\'\,\.\/\<\>\?【】]/g, ' ');
    };
    IndexComponent.prototype.searchDouban = function (key, input) {
        return __awaiter(this, void 0, void 0, function () {
            var url, res, doubanSearchResult_1, err_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        url = "https://search.douban.com/movie/subject_search?search_text=" + encodeURIComponent(key) + "&cat=1002";
                        return [4 /*yield*/, superagent.get(url)];
                    case 2:
                        res = _a.sent();
                        if (/window\.__DATA__\s*=\s*"(.*)"/.test(res.text)) {
                            doubanSearchResult_1 = decrypt(RegExp.$1);
                            console.log('douban-search', doubanSearchResult_1);
                            this._ngZone.run(function () { return _this.doubanSearchResult = doubanSearchResult_1; });
                        }
                        else {
    ...
    IndexComponent.prototype.searchOperate = function () {
        this.operator = 'search';
        var node = this.explorer.getSelected();
        this.folderSearchName = node ? node.name : '';
    };
    IndexComponent.prototype.searchFolder = function (key, input) {
        if (input.selectionStart !== input.selectionEnd) {
            key = key.slice(input.selectionStart, input.selectionEnd);
        }
        this.folderSearchResult = this._searchFolder(key, this.explorer.getData());
    };
    IndexComponent.prototype._searchFolder = function (key, data) {
        var _this = this;
        var result = [];
        data.forEach(function (node) {
            ...
            result.push.apply(result, _this._searchFolder(key, node.children));
        });
        return result;
    };
    IndexComponent.prototype.openItem = function (node) {
        this.electron.shell.openItem(node.fullpath);
    };
    IndexComponent.prototype.openItemFolder = function (node) {
        this.electron.shell.openItem(this.electron.path.dirname(node.fullpath));
    };
    IndexComponent.prototype.genName = function (item) {
        return (item.title + " ; " + item.rating.value + " ; " + item.abstract.split(' / ').join(' ; ') + " ; " + item.abstract_2.split(' / ').join(' ; ')).replace(/\//g, '');
    };
    IndexComponent.prototype.nameing = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var node, _a, name, fullpath, expandable, _b, promises, path, refreshPath, targetFolder;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        node = this.explorer.getSelected();
                        _a = this.explorer.getSelected(), name = _a.name, fullpath = _a.fullpath, expandable = _a.expandable;
                        _b = this.electron, promises = _b.fs.promises, path = _b.path;
                        refreshPath = path.resolve(fullpath, '../');
                        targetFolder = path.resolve(refreshPath, this.genName(item));
                        if (!expandable) return [3 /*break*/, 2];
                        return [4 /*yield*/, promises.rename(fullpath, targetFolder)];
                    case 1:
                        _c.sent();
                        return [3 /*break*/, 5];
                    case 2: // 新建文件夹,并移动文件至其中
                    return [4 /*yield*/, promises.mkdir(targetFolder, { recursive: true })];
                    case 3:
                        _c.sent();
                        return [4 /*yield*/, promises.rename(fullpath, path.join(targetFolder, name))];
                    case 4:
                        _c.sent();
                        _c.label = 5;
                    case 5:
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_core_explorer_explorer_component__WEBPACK_IMPORTED_MODULE_2__["ExplorerComponent"], { static: true }),
        __metadata("design:type", _core_explorer_explorer_component__WEBPACK_IMPORTED_MODULE_2__["ExplorerComponent"])
    ], IndexComponent.prototype, "explorer", void 0);
    IndexComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-index',
            template: __importDefault(__webpack_require__(/*! raw-loader!./index.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/film/index/index.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./index.component.scss */ "./src/app/film/index/index.component.scss")).default]
        }),
